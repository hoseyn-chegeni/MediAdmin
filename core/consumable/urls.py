...
urlpatterns = [
    ...
    path("inventory_detail/<int:pk>/", InventoryDetailView.as_view(), name="inventory_detail"),
    path("inventory_create/", InventoryCreateView.as_view(), name="inventory_create"),
    path("inventory_update/<int:pk>/", InventoryUpdateView.as_view(), name="inventory_update"),
    path("inventory_delete/<int:pk>/", InventoryDeleteView.as_view(), name="inventory_delete"),
]
